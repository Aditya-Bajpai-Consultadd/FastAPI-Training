...
from models import  BookResponse, BookCreate, BookUpdate, BorrowRequest, BorrowResponse, ReturnRequest, ReturnResponse, Token, UserCreate
...
def borrow_book(borrow_data: BorrowRequest, db: Session = Depends(get_db)):
